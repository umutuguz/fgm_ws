...
namespace local_planner
{
    ...
    double LocalPlanner::LLCallback()
    {
        ...
        else
        {
            ...
            {
                if(midpoint_coords[i][2] > 0.65) //genişliği 0.65'ten küçük olan gapler hafızaya atılmaz
                {
        ...
        if (midpoint_memory.size() >= 20) //memorydeki gap sayısını 30'da tutmak için 30'dan fazlalık olan ilk elemanlar silinir.
        {
            int elements_to_delete = midpoint_memory.size() - 20;
