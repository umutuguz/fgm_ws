...
p = rospy.Publisher("/pictogram", Pictogram, queue_size=1)
...
# Will show the pictograms asociated with the strings given
uint8 PICTOGRAM_MODE=0
# Will show the strings and not the icons asociated
uint8 STRING_MODE=1
...
string character                                                                                                                                                          
float64 size  
# Time secondsactive and then dissappears
float64 ttl
...
while not rospy.is_shutdown():
    ...
    msg.header.frame_id = "/person_standing"
